...
@Table(name="business_target", alias="a", columns={
		...
		@Column(name="target_type_id", attrName="targetType", label="关联分类ID"),
		...
		@Column(name="target_execute_dep_id", attrName="executeDepartment", label="目标执行部门"),
		@Column(name="target_join_dep_id", attrName="jointWorkDepartment", label="协同部门"),
...
public class BusinessTarget extends DataEntity<BusinessTarget> {
	...
	private BusinessTargetType targetType;		// 关联分类ID
