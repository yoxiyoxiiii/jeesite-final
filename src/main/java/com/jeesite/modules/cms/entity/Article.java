 ...
 * @version 2018-10-15
 */
@Table(name = "${_prefix}cms_article", alias = "a", columns = { @Column(name = "id", attrName = "id", label = "编号", isPK = true),
		...
		@Column(name = "href", attrName = "href", label = "外部链接"), @Column(name = "color", attrName = "color", label = "标题颜色"),
		@Column(name = "image", attrName = "image", label = "内容图片"), @Column(name = "keywords", attrName = "keywords", label = "关键字"),
		@Column(name = "description", attrName = "description", label = "描述"), @Column(name = "weight", attrName = "weight", label = "权重，越大越靠前"),
		@Column(name = "weight_date", attrName = "weightDate", label = "权重期限"),
		@Column(name = "source", attrName = "source", label = "来源", comment = "来源（转载/原创）"),
		@Column(name = "copyfrom", attrName = "copyfrom", label = "文章来源出处"), @Column(name = "hits", attrName = "hits", label = "点击数"),
		@Column(name = "hits_plus", attrName = "hitsPlus", label = "支持数"), @Column(name = "hits_minus", attrName = "hitsMinus", label = "反对数"),
		...
		@Column(includeEntity = BaseEntity.class), }, orderBy = "a.update_date DESC")
public class Article extends DataEntity<Article> {
	public static final String DEFAULT_TEMPLATE = "frontViewArticle"; // 默认文章内容模板
