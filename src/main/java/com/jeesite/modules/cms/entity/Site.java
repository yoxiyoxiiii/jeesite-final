 ...
 * @version 2018-10-15
 */
@Table(name = "${_prefix}cms_site", alias = "a", columns = { @Column(name = "site_code", attrName = "siteCode", label = "站点编码", isPK = true),
		...
		@Column(name = "logo", attrName = "logo", label = "站点Logo"), @Column(name = "domain", attrName = "domain", label = "站点域名"),
		@Column(name = "keywords", attrName = "keywords", label = "关键字"), @Column(name = "description", attrName = "description", label = "描述"),
		@Column(name = "theme", attrName = "theme", label = "主题"), @Column(name = "copyright", attrName = "copyright", label = "版权信息"),
