 ...
 * @version 2018-10-15
 */
@Table(name = "${_prefix}cms_article_data", alias = "a", columns = { @Column(name = "id", attrName = "id", label = "编号", isPK = true),
		@Column(name = "content", attrName = "content", label = "文章内容"), @Column(name = "relation", attrName = "relation", label = "相关文章"),
		@Column(name = "is_can_comment", attrName = "isCanComment", label = "是否允许评论"),
		@Column(includeEntity = Extend.class, attrName = "extend"), }, orderBy = "a.id DESC")
